...
function Hero() {
    ...
    return (
        <div className='relative'>
            <div className='absolute inset-0 blur-xl h-[580px]' style={{ background: "linear-gradient(143.6deg, rgba(99, 102, 241, 0.1) 20.79%, rgba(99, 102, 241, 0.36) 40.92%, rgba(99, 102, 241, 0.1) 70.35%)" }}></div>
            <div className='relative'>
                <header>
                ...
                <section>
                    <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 overflow-hidden md:px-8 md:flex">
                        <div className='flex-none space-y-5 max-w-xl'>
                            ...
                            <h3 className="text-xxl text-gray-800 font-bold sm:text-xl">
                            Trusted By
                            </h3>
                            
                            <div className='flex justify-start items-center gap-5 mb-[15px] '>
